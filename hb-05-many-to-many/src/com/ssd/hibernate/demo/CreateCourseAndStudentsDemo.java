...
import com.ssd.hibernate.demo.entity.Review;
...
public class CreateCourseAndStudentsDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// create the students
			Student tempStudent1 = new Student("John", "Doe", "john@ssd.com");
			Student tempStudent2 = new Student("Mary", "Public", "mary@ssd.com");
